        ...
        <div ref={contextRef}>
            <div style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)" }}>
                <div ref={headerRef} className="flex flex-col justify-center gap-12 pt-16 sm:gap-16">
                    ...
                    <div className="px-10">
                        <h1 className={`flex flex-col flex-wrap gap-12 uppercase banner-text-responsive sm:gap-16 md:block p-4 ${textColor}`}>{title}</h1>
                    </div>
                </div>
            </div>
            <div className="relative px-10">
                <div className="absolute inset-x-0 border-t-2">
                    <div className="py-12 sm:py-16 text-end">
                        <AnimatedTextLines text={text} className={`font-light uppercase value-text-responsive px-6 ${textColor}`} />
                    </div>
