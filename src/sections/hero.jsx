...
const Hero = () => {
    ...
    return <section id="home" className="flex flex-col justify-center min-h-screen">
        <div ref={contextRef}>
            <div style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 0 100%)" }}>
                <div ref={headerRef} className="flex flex-col justify-center gap-12 pt-16 sm:gap-16">
                    ...
                    <div className="px-10">
                        <h1 className="flex flex-col flex-wrap gap-12 text-black uppercase banner-text-responsive sm:gap-16 md:block">Baibhab</h1>
                    </div>
                </div>
            </div>
            ...
            <Canvas shadows camera={{ position: [0, 0, -10], fov: 17.5, near: 1, far: 20 }}>
                ...
                <Environment resolution={256}>
                    <group rotation={[-Math.PI / 3, 4, 1]}>
                        <Lightformer from={"circle"} intensity={2} position={[0, 5, -9]} scale={10} />
                        <Lightformer from={"circle"} intensity={2} position={[0, 3, -1]} scale={10} />
                        <Lightformer from={"circle"} intensity={2} position={[5, -1, -1]} scale={10} />
                        <Lightformer from={"circle"} intensity={2} position={[10, 1, 0]} scale={16} />
                    </group>
                </Environment>
            </Canvas>
        </figure>
